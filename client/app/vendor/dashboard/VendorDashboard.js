...
export default function VendorDashboard({ user, vendorData }) {
  // Helper functions
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
                    {vendorData.dashboard.totalOrders}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
                    {vendorData.dashboard.pendingOrders}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
                    {vendorData.averageDailyCustomers}
                  </p>
                </div>
              </div>
            </div>
